...
namespace SalleDeSportMaroc.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directement dans votre code. Cette API peut changer ou être supprimée dans les futures versions.
            /// </summary>
            [Required(ErrorMessage = "Un e-mail est requis.")]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Lien de confirmation pour changer l'e-mail envoyé. Veuillez vérifier votre boîte de réception.";
                return RedirectToPage();
            }

            StatusMessage = "Votre e-mail est inchangé.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "E-mail de vérification envoyé. Veuillez vérifier votre boîte de réception.";
            return RedirectToPage();
        }
    }
}