    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Un nouvel utilisateur a créé un compte avec un mot de passe.");
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Impossible de créer une instance de '{nameof(ApplicationUser)}'. " +
                    $"Assurez-vous que '{nameof(ApplicationUser)}' n'est pas une classe abstraite et dispose d'un constructeur sans paramètre, ou " +
                    $"surchargez la page d'inscription dans /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("L'interface par défaut nécessite un magasin d'utilisateurs avec prise en charge de l'e-mail.");
            }
